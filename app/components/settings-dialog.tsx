...
const tilde = (p: string | null | undefined) =>
          ...
          <div className="set-body">
            ...
            <div className="set-section">
              ...
              <Row
                label="Credentials"
                hint={
                  account?.tokenSource === "VERCEL_TOKEN"
              ...
              {linked.length ? (
                linked.map((p) => (
                  <div key={p.name} className="set-link">
                    ...
                    <span className="set-link-path mono" title={p.localPath ?? undefined}>
                      {tilde(p.localPath)}
                    </span>
                ...
                <div className="set-empty">
                  No agent has a folder on this Mac yet — open Build on one and choose its folder.
                </div>
              )}
            </div>
                ...
                {confirmOut ? (
                  <>
                    ...
                    <span className="set-signout-row">
                      ...
                      <Button variant="outline" size="sm" onClick={() => setConfirmOut(false)}>
                        Cancel
                      </Button>
                    </span>
                  </>
