...
function parseMeta(meta: string | undefined): string | null {
  if (!meta) return null;
...
export default function CodeBlock({
  ...
  const langName =
    LANG_NAMES[language.toLowerCase() as keyof typeof LANG_NAMES] ?? (language || null);
