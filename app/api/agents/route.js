...
import { remember, forget } from "../../../lib/registry.js";
import { isAgentName } from "../../../lib/agent-name.js";
...
export async function POST(request) {
  ...
  if (!existsSync(join(path, "package.json")))
    return Response.json({ error: "The scaffold didn't complete — see the terminal above." }, { status: 422 });
