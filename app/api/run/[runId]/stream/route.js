...
import { worldFor } from "../../../../../lib/vercel-client.js";
    ...
    async start(controller) {
      ...
      try {
        ...
        try {
          ...
          if (info?.done) { frame({ type: "done" }); try { controller.close(); } catch {} return; }
        ...
        frame({ type: "error", error: String(e?.message ?? e).slice(0, 200) });
      }
      closed = true;
      try { controller.close(); } catch {}
    },
