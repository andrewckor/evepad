...
export function agentNameError(name: string | null | undefined): string | null {
  const v = name ?? "";
...
export const isAgentName = (name: string | null | undefined): boolean =>
  agentNameError(name) === null;
